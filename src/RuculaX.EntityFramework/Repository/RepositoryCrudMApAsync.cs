        ...
        where TentityDto : IEntityDto
{
    ...
    public abstract Task<TentityDto> GetAsync(TEntity input, CancellationToken token = default);
    public abstract Task<TentityDto> GetAsync(Expression<Func<TEntity, bool>> predicate, CancellationToken token = default);
}
